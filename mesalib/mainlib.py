...
#
###########################################################
def make_NR_file(MESA_file,masscut,N,mp,stepsize,NR_file_name, *args, **kwargs):
...
def reload_IC(rmax, NR_file, IC_file, format_type):
    #
    ...
    return cf.to_array(r_temp), cf.to_array(rho_temp)