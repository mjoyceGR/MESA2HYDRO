...
fname='../data/profile175.data'#'profile175.data' #175, 140, 32
...
#taken from analytical fit
mp=0.000276315684227#1e-5#8
n_p_initial=1000#3072#3000 #72#3072#100,000 
stepsize=0.0001#
...
fit_region_R = cf.get_MESA_profile_edge(MESA_file, quantity='logR', masscut=0.65,strip=False)
fit_region_rho = cf.get_MESA_profile_edge(MESA_file, quantity='logRho', masscut=0.65 ,strip=False)
...
test_num_part=n_p_initial #3072#16#10.0e7
...
shell_ru=rl
while shell_ru < rmax:
	shell_ru, N= cf.get_N_continuous(shell_ru, rmax, A, B, C, mp, stepsize, tolerance)
...
print "shell radii through numerical fit: ", shell_radii_num, N_num
print "\nshell radii through analytical fit: ", shell_radii, N_a
