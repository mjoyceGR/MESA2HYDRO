...
fname='../out/profile_mainsequence.data'
tag='ms'
...
fit=r"analytical fit $g(y)$ = %1.4s [1/($r$ + %1.4s)] + %1.4s"%(A,B,C)  #(4.9,60.9,-11)
print '\n\n', fit, '\n\n'
...
# plt.plot(fit_region_R, analytic_rho,'m-',linewidth=2.0)
# plt.show()
# plt.close()
...
plt.ylabel(r'$\rho$')
plt.savefig('NUMERIC_rhovr_'+tag+'.png')
plt.close()
