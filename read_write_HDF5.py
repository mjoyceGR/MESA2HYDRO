...
#------ suggested method 1------------------------------- 9/26/17
#1. do not specifiy hdf5 interface:
#
import hdf5lib


#------ suggested method 2b------------------------------- 9/26/17
# import hdf5lib_param
# hdf5lib_param.setlib("tables")
# import hdf5lib
# import snapHDF5
# print "hdf5lib.tables.__version__ :", hdf5lib.tables.__version__
...
# import hdf5lib
# import snapHDF5
#print "hdf5lib.h5py.version: ", hdf5lib.h5py.version


#import hdf5lib

#import /usr/lib/python2.7/dist-packages/h5pyViewer-0.0.1.6/build/lib/python-hdf5lib/hdf5lib as hdf5lib# 9/5/17
